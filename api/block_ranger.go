...
type dbTX struct {
	...
	Vin           []btcjson.Vin  `storm:"inline"`
	Vout          []btcjson.Vout `storm:"inline"`
...
func WriteBlock(block *btcjson.GetBlockVerboseResult, blockArrayIndex int64) {
...
func WriteTX(tx *btcjson.TxRawResult, txArrayIndex int64) {
